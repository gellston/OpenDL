...
class model_segmentation_CrackDetector:
    ...
    def _build_net(self):
        with tf.variable_scope(self.name):
            ...
            self.X = tf.placeholder(tf.float32, [None, 200, 1000, 3], name='input')
            self.Y = tf.placeholder(tf.float32, [None, 200, 1000, 1], name='output')
            ...
            ##up0 = joint1
            up1 = upsample_layer(joint2, [250, 50])
            up2 = upsample_layer(joint3, [250, 50])
            up3 = upsample_layer(joint4, [250, 50])
            up4 = upsample_layer(joint5, [250, 50])
            ...
            pre_feature_conv = upsample_layer(concat2, [500, 100])
            ...
            last_feature = upsample_layer(feature_relu, [1000, 200])
