...
from model.model_segmentation_ChassisWallDetector import model_segmentation_ChassisWallDetector
...
sess = tf.Session()
model = model_segmentation_ChassisWallDetector(sess=sess, name="model_segmentation_ChassisWallDetector")
...
saver.save(sess, 'C:/Github/OpenDL/python/pretrained-model/model_segmentation_ChassisWallDetector/model_segmentation_ChassisWallDetector')
tf.train.write_graph(sess.graph_def, "", 'C:/Github/OpenDL/python/pretrained-model/model_segmentation_ChassisWallDetector/model_segmentation_ChassisWallDetector.pbtxt', as_text=True)
