...
from model.model_segmentation_CrackDetector import model_segmentation_CrackDetector
...
sess = tf.Session()
model = model_segmentation_CrackDetector(sess=sess, name="model_segmentation_CrackDetector")
...
saver.save(sess, 'C:/Github/OpenDL/python/pretrained-model/model_segmentation_CrackDetector/model_segmentation_CrackDetector')
tf.train.write_graph(sess.graph_def, "", 'C:/Github/OpenDL/python/pretrained-model/model_segmentation_CrackDetector/model_segmentation_CrackDetector.pbtxt', as_text=True)
