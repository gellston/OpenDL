...
sess = tf.Session()
saver = tf.train.import_meta_graph('C:/Github/OpenDL/python/pretrained-model/model_anomalydetection_SSMIAUTO/model_anomalydetection_SSMIAUTO.meta')
saver.restore(sess, tf.train.latest_checkpoint('C:/Github/OpenDL/python/pretrained-model/model_anomalydetection_SSMIAUTO/'))

graph = tf.get_default_graph()
phase = graph.get_tensor_by_name("model_anomalydetection_SSMIAUTOV2/phase:0")
X = graph.get_tensor_by_name("model_anomalydetection_SSMIAUTOV2/RealTarget:0")
Heatmap = graph.get_tensor_by_name("model_anomalydetection_SSMIAUTOV2/Sigmoid:0")
...
img = cv2.imread("C:/Downloads/wood.tar/wood/wood/test/hole/001.png", cv2.IMREAD_GRAYSCALE)
