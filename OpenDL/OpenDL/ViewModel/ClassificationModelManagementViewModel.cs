...
{
    public class ClassificationModelManagementViewModel : ViewModelBase
    {
        ...
        public ClassificationModelManagementViewModel(DialogService _dialogService,
        ...
        public ICommand RefreshPureModelCommand
        {
            get
            {
                if (_RefreshPureModelCommand == null)
                {
                    ...
                    {
                        string[] files = Directory.GetFiles(this.configureService.ClassificationPureModelContainerPath, "*.model");
        ...
        public ICommand RefreshTrainedModelCommand
        {
            get
            {
                if (_RefreshTrainedModelCommand == null)
                {
                    ...
                    {
                        string[] files = Directory.GetFiles(this.configureService.ClassificationTrainedModelContainerPath, "*.model");
